...
if (import.meta.env.DEV && location.hostname === '127.0.0.1') {
  ...
  createRoot(document.getElementById('root')!).render(<VoicePilotPanel initialText={params.get('phrase') || 'ajoute deux packs de six yaourts, un nature et l’autre à la fraise'} foyerId="foyer-test" memberId="parent-test" scope="test:foyer-test:parent-test" onClose={() => { document.body.dataset.closed = 'true'; }} onSaved={() => { document.body.dataset.saved = 'true'; }} />);
}
