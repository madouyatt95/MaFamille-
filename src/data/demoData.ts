...
export const demoDishes: Dish[] = [
  { id: 'di1', day: 'Lun', mealType: 'lunch', name: 'Poulet rôti et pommes de terre', image: 'utensils', ingredients: ['Poulet', 'Pommes de terre', 'Ail', 'Herbes de Provence'] },
  { id: 'di2', day: 'Lun', mealType: 'dinner', name: 'Soupe de légumes et croûtons', image: 'soup', ingredients: ['Poireaux', 'Carottes', 'Pommes de terre', 'Pain'] },
  { id: 'di3', day: 'Mar', mealType: 'lunch', name: 'Salade de quinoa et avocat', image: 'salad', ingredients: ['Quinoa', 'Avocat', 'Tomates', 'Feta'] },
  { id: 'di4', day: 'Mar', mealType: 'dinner', name: 'Pâtes à la bolognaise maison', image: 'pasta', ingredients: ['Pâtes', 'Bœuf haché', 'Sauce tomate', 'Oignons'] },
  { id: 'di5', day: 'Mer', mealType: 'lunch', name: 'Pavé de saumon et riz blanc', image: 'fish', ingredients: ['Saumon', 'Riz', 'Citron', 'Aneth'] },
  { id: 'di6', day: 'Mer', mealType: 'dinner', name: 'Quiche aux épinards et chèvre', image: 'pie', ingredients: ['Pâte brisée', 'Épinards', 'Fromage de chèvre', 'Œufs'] },
  { id: 'di7', day: 'Jeu', mealType: 'lunch', name: 'Wrap au thon et crudités', image: 'wrap', ingredients: ['Galettes wrap', 'Thon', 'Mayonnaise', 'Salade'] },
  { id: 'di8', day: 'Jeu', mealType: 'dinner', name: 'Gratin de chou-fleur béchamel', image: 'gratin', ingredients: ['Chou-fleur', 'Béchamel', 'Fromage râpé'] },
  { id: 'di9', day: 'Ven', mealType: 'lunch', name: 'Steak haché et haricots verts', image: 'meat', ingredients: ['Bœuf', 'Haricots verts', 'Beurre'] },
  { id: 'di10', day: 'Ven', mealType: 'dinner', name: 'Pizzas maison en famille', image: 'pizza', ingredients: ['Pâte à pizza', 'Sauce tomate', 'Mozzarella', 'Jambon'] },
  { id: 'di11', day: 'Sam', mealType: 'lunch', name: 'Brochettes de bœuf au barbecue', image: 'barbecue', ingredients: ['Bœuf', 'Poivrons', 'Oignons'] },
  { id: 'di12', day: 'Sam', mealType: 'dinner', name: 'Tacos express croustillants', image: 'tacos', ingredients: ['Coquilles tacos', 'Viande hachée', 'Épices', 'Salsa'] },
  { id: 'di13', day: 'Dim', mealType: 'lunch', name: 'Gigot d\'agneau dominical', image: 'lamb', ingredients: ['Agneau', 'Ail', 'Romarin', 'Flageolets'] },
  { id: 'di14', day: 'Dim', mealType: 'dinner', name: 'Crêpes salées et sucrées', image: 'pancakes', ingredients: ['Farine', 'Lait', 'Œufs', 'Fromage', 'Nutella'] }
];
...
export const demoAlerts: NotificationAlert[] = [
  ...
  { id: 'a4', title: 'Tâche validée', description: 'Maman a validé la tâche d\'Awa : vider le lave-vaisselle (+15 points d\'argent de poche).', time: 'Hier', type: 'success', read: true }
];
