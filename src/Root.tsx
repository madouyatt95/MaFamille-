...
const shouldRenderApp = () => {
  ...
  if (pathname.startsWith('/app') || pathname.startsWith('/quick-micro') || pathname.startsWith('/action/') || pathname.startsWith('/share') || pathname.startsWith('/share-target')) return true;
